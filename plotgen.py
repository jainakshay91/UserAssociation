...
simdata_path = os.path.dirname(os.getcwd()) + '/Result_files/CircularDeploy_AnyDC/IF/MRT1/Process/'
...
plt.close("all")
hmap_data = np.load(os.path.dirname(os.getcwd()) +'/Result_files/CircularDeploy_AnyDC/IF/Temp/hmap_'+iter_num+'.npz', allow_pickle='True')
