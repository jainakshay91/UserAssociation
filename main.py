...
sinr, locs_sc_ret, usr_lcs, idx_sc, sinr_pad, num_SCBS, num_MCBS = scenario_gen.sinr_gen (scn, sum(SCBS_per_MCBS), macro_cell_locations, np.asarray(locs_SCBS), usr_locs['user_locations0'], dsc, np)
