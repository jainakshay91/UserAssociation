...
try:
	if lcdata_flag == 0:
		...
		np.savez_compressed(os.getcwd()+'/Data/loc/loc'+str(vars(args)['iter'])+'.npz', SCBS_per_MCBS, macro_cell_locations, locs_SCBS, SC_wl_bh, SC_wrd_bh, MC_hops, SC_hops, BH_capacity_SC, SCBS_MCBS_assoc)
