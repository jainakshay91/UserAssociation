...
# ================================================================
# Small cell placement and MCBS-SCBS association matrix generation
# ================================================================
...
SCBS_MCBS_assoc = np.zeros((sum(SCBS_per_MCBS),macro_cell_locations.shape[0]), dtype=int); # Create a MCBS and SCBS association matrix
...
for i in range(0,macro_cell_locations.shape[0]):
    ...
    SCBS_MCBS_assoc[l_idx:u_idx,i] = np.ones(SCBS_per_MCBS[i],dtype=int); # Insert ones in these indexes for the association matrix
