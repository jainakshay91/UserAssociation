...
var1, var2, var3 = scenario_gen.backhaul_dump(min_num_hops, max_num_hops, SCBS_per_MCBS, macro_cell_locations, SCBS_MCBS_assoc, np, wl_bh_bp); # We drop the backhaul into the scenario
