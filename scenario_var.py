...
class scenario_var:
	...
	user_steps_siml = 50; # For the simulation we increase users in steps of 10,000
	...
	wrd_link_delay = 2.5*1e-3; # 2.5 ms link delay for the wired link [Mona Jaber Paper]
